...
class Shared_parameters:
    ...
    # AVR_Поверх
    LEVEL = Guid("d3d0a77a-2849-4874-8730-afb9462ffcd2")

    # AVR_Площа порогів дверей
    ROOM_DOORSETP_AREA = Guid("e6170223-c375-4982-af30-c72277456d3c")

    # AVR_Площа порогів вікон
    WINDOW_SILL_AREA = Guid("91ad10ba-3b0b-4794-bfa9-58a548acb5a1")
    ...
    BUILDING_DEV_PHASE_NUMBER = Guid("c951eca4-3b6b-4c62-a6cb-406bbf4a7f6f")
    ...
    # ============================================================
    # ========================= STAIRS =========================
    # AVR_Сходи_Відлік для нумерації
    BASE_STAIRS = Guid("b5283630-1591-449b-b78a-3703b4a6c600")
