...
Curtain Panels
2. Вид "Інсоляція" створюється автоматично, якщо його ще немає, але усі категорії видимі, усе крім вікон, вітражних панелей ідверей - напівтоном. Існуючий вид не змінюється
