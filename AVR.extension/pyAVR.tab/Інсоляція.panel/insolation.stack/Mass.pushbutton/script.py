...
Кнопка запускає розрахунок інсоляції для сітки точок на всіх
вертикальних площинах Mass, Floors, Roofs, враховуючи тільки
геометрію видиму у виді "Інсоляція".

Крок сітки точок розрахунку отримується від користувача. Крок
позицій сонця за годину також.
